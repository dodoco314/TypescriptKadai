...
class Calculator {
    constructor() {
        ...
        Object.defineProperty(this, "_isDegMode", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: true
    ...
    evalFunction(func, val) {
        ...
        switch (func) {
            ...
            case 'log':
                if (val <= 0)
                    throw new Error('Logarithm domain error');
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    window.addEventListener('keydown', (e) => {
        ...
        if (mappedVal) {
            ...
            let btnEl = null;
            if (idToHighlight) {
                btnEl = document.getElementById(idToHighlight);
            }
            else {
                btnEl = document.querySelector(`.key[data-val="${mappedVal}"]`);
            }
            if (btnEl) {
